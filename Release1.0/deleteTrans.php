<?php 
/* Takes input for deleting a transaction and sends it to deleteTransPost.php */
require 'db.php';
session_start();

if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    require 'deleteTransPost.php';
}
  ...
  <div class="w3-twothird w3-container">
      ...
      <div class="tab-content">
         ...
         <div id="login">   
          ...
          <form action="deleteTrans.php" method="post" autocomplete="off">
