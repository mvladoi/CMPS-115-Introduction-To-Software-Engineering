<?php 
/* Contact page featuring the team names and email addresses */
require 'db.php';
session_start();
...
<h1>Team name: Coding Conduct.</h1>
		  ...
		  <p></p>
          <p>Marian Vladoi - mvladoi@ucsc.edu<br />
          Matthew Frank - maafrank@ucsc.edu<br />
          Mikhail Lychagin - mlychagi@ucsc.edu<br />
          Nick Pappas - nhpappas@ucsc.edu<br />
          Hasson Qayum - hqayum@ucsc.edu</p>
