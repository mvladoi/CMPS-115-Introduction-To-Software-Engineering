<?php 
/* Takes start and end dates from datePrint and prints the table accordingly*/
require 'db.php';
session_start();

$query = "SELECT first_name, last_name  FROM users WHERE active= 1";
$start = $mysqli->escape_string($_POST['start']);  //starting date
$end = $mysqli->escape_string($_POST['end']); // ending date
$temp = "";
